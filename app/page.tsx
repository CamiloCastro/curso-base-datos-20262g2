...
const chapters: { n: number; sessions: number; topic: string; detail: string; slides?: string; diagrams?: { label: string; url: string }[] }[] = [
  ...
  { n: 4, sessions: 2, topic: "Modelo Relacional III", detail: "Generalización y especialización · jerarquías es-un · validación y refinamiento del diagrama ER · modelado de casos completos.", slides: "https://drive.google.com/file/d/1Z0myW9ZTvR_2pO-c6X1BhkrHPzoz6p-4/view?usp=sharing", diagrams: [
